...
Spacey.jl finds the **point group** of a Bravais lattice and the **space group** of a crystal. Other symmetry packages like FINDSYM, spglib, and aflow-sym additionally provide spacegroup names, Niggli cell reduction, and standard settings — Spacey deliberately does not.
