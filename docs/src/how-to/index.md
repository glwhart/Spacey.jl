...
- [Compose and apply operations](compose-and-apply-ops.md) — `SpacegroupOp` cookbook: apply, compose, invert, equality, `to_cartesian`.
- [Snap a noisy lattice to symmetry](snap-to-symmetry.md) — `snap_to_symmetry_svd` recipe with a 1%-noise near-cubic example.
